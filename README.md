> [!NOTE]
> **Fork provenance.** This repository is retained under the CamCore GitHub account as a fork of [morpheus65535/bazarr](https://github.com/morpheus65535/bazarr). The current default branch contains no CamCore-specific implementation. Its presence does not indicate an active CamCore deployment, CamCore operational support or original CamCore authorship. Use the upstream project for product documentation and support; the upstream README and licence continue below unchanged.
